		...
		if (typeof this.props.data == "undefined") {
			...
			return (
				<div className="small-margin container form-group">
					...
					<ProvTabs propValues={this.props.data} onValueClick={this.props.onValueClick} expandClick={this.props.expandClick} extraLinkClick={this.props.onLinkClick} errorText={this.props.errorText}/>
				</div>
			);
		} else {
			return (
